...
function updateStatistics(site){document.querySelectorAll('[data-stat-value]').forEach(el=>{const field=statisticFields[el.dataset.statValue];if(field)animateStatistic(el,site[field])})}
