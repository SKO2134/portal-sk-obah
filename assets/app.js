...
const defaults = {
  site: { schoolName:'Sekolah Kebangsaan Obah', shortName:'SK Obah', tagline:'Beluran, Sabah', motto:'Berilmu, Berbakti, Berjaya', facebookUrl:'', phone:'', email:'', address:'Beluran, Sabah', totalStudents:0, totalTeachers:0, totalStaff:0, totalClasses:0, totalAchievements:0 },
...
const statisticFields={students:'totalStudents',teachers:'totalTeachers',staff:'totalStaff',classes:'totalClasses',achievements:'totalAchievements'};
